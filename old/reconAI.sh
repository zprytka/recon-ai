...
# reconIA.sh
# Requirements: subfinder, httpx, nuclei, curl, jq, ollama with mistral or deepseek-r1
...
# 7. Run LLM with Ollama
echo "[*] Sending prompt to DeepSeek..."
